...
$Language->setMultiple('pages/login',array(
    'title'=>'تسجيل الدخول',
    'description'=>'صفحة تسجيل الدخول إلى النظام.'
));
...
$Language->setMultiple('pages/login/placeholders', array(
    'username' => 'أدخل اسم المستخدم او البريد الإلكتروني هنا.',
    'password' => 'أدخل كلمة المرور هنا.',
));
$Language->setMultiple('pages/login/errors', array(
    'something-wrong'=>'حصل خطأ غير معروف. الرجاء المحاولة لاحقةً.',
    'incorrect-login-params' => 'إسم المستخدم او البريد الإلكتروني او كلمة المرور خطأ.',
    'err-missing-pass' => 'الرجاء كتابة كلمة المرور.',
    'err-missing-username' => 'الرجاء كتابة إسم المستخدم او البريد الإلكتروني.'
));
$Language->setMultiple('pages/login/actions', array(
    'login'=>'تسجيل الدخول',
    'fogot-pass'=>'هل نسيت كلمة المرور؟'
));
