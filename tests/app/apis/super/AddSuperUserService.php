...
/**
 * A class that contains the implementation of the web service 'add-super-user'.
 ...
 * </ul>
 */
class AddSuperUserService extends AbstractWebService {
    /**
     * Creates new instance of the class.
     */
    public function __construct() {
        parent::__construct('add-super-user');
        $this->setDescription('');
    ...
    public function isAuthorized() {
        // TODO: Check if the client is authorized to call the service 'add-super-user'.
    ...
    public function processRequest() {
        $entity = $this->getObject(SuperUser::class);
        
        SuperUserDB::get()->addSuperUser($entity);
        $this->sendResponse('Record Created.');
    }
}
