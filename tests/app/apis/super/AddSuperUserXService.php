...
/**
 * A class that contains the implementation of the web service 'add-super-user-x'.
 ...
 * </ul>
 */
class AddSuperUserXService extends AbstractWebService {
    /**
     * Creates new instance of the class.
     */
    public function __construct() {
        parent::__construct('add-super-user-x');
        $this->setDescription('');
    ...
    public function isAuthorized() {
        // TODO: Check if the client is authorized to call the service 'add-super-user-x'.
    ...
    public function processRequest() {
        ...
        SuperUserXDB::get()->addSuperUserX($entity);
