...
/**
 * A class that contains the implementation of the web service 'update-id-of-super-user-x'.
 * This service has the following parameters:
 * <ul>
 * <li><b>id</b>: Data type: integer.</li>
 * </ul>
 */
class UpdateIdOfSuperUserXService extends AbstractWebService {
    /**
     * Creates new instance of the class.
     */
    public function __construct() {
        parent::__construct('update-id-of-super-user-x');
        $this->setDescription('');
    ...
    public function isAuthorized() {
        // TODO: Check if the client is authorized to call the service 'update-id-of-super-user-x'.
    ...
    public function processRequest() {
        // TODO: process the request for the service 'update-id-of-super-user-x'.
