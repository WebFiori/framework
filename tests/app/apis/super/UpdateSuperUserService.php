...
/**
 * A class that contains the implementation of the web service 'update-super-user'.
 ...
 * </ul>
 */
class UpdateSuperUserService extends AbstractWebService {
    /**
     * Creates new instance of the class.
     */
    public function __construct() {
        parent::__construct('update-super-user');
        $this->setDescription('');
    ...
    public function isAuthorized() {
        // TODO: Check if the client is authorized to call the service 'update-super-user'.
    ...
    public function processRequest() {
        ...
        SuperUserDB::get()->updateSuperUser($entity);
