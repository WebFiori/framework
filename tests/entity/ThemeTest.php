...
class ThemeTest extends TestCase {
    ...
    public function testToJson00() {
        ...
        $this->assertEquals('{"themesPath":"'. \webfiori\json\Json::escapeJSONSpecialChars(THEMES_PATH).'", "name":"New Fiori", "url":"", "license":"MIT", "licenseUrl":"", "version":"1.0", "author":"", "authorUrl":"", "imagesDirName":"images", "themeDirName":"new-wf", "cssDirName":"css", "jsDirName":"js", "components":[]}',$j.'');
    }
    /**
     * @test
     */
