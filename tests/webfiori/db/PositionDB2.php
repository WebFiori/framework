...
class PositionDB2 extends DB {
     ...
     * 
     * @return PositionDB2 An instance of the class.
     */
    public static function get() : PositionDB2 {

        if (self::$instance === null) {
            self::$instance = new PositionDB2();
        }
    ...
    public function __construct() {
        parent::__construct('ok-connection');
